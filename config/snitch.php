...
return [
    ...
    */
    ...
    'video_analysis' => [
        ...
        // qwen3.7-flash on NanoGPT allows up to 65536 output tokens.
        'max_tokens' => (int) env('SNITCH_VIDEO_ANALYSIS_MAX_TOKENS', 32768),
        'transcript_continuation' => [
            'enabled' => filter_var(env('SNITCH_VIDEO_ANALYSIS_TRANSCRIPT_CONTINUATION', true), FILTER_VALIDATE_BOOLEAN),
            'max_attempts' => (int) env('SNITCH_VIDEO_ANALYSIS_TRANSCRIPT_CONTINUATION_ATTEMPTS', 2),
            'max_tokens' => (int) env('SNITCH_VIDEO_ANALYSIS_TRANSCRIPT_CONTINUATION_MAX_TOKENS', 16384),
        ],
    ...
    'tikhub' => [
        ...
        'endpoints' => [
            ...
            'youtube' => [
                ...
                // Muxed stream list (MP4 URLs). web/get_video_info_v2 now 404s.
                'video_info' => '/api/v1/youtube/web_v2/get_video_streams',
