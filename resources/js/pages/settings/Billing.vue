    ...
    <div>
        ...
        <div class="snitch-doc relative space-y-8 p-5 sm:p-6">
            ...
            <div class="relative z-10">
                <h2 class="snitch-display text-2xl text-snitch-ink">Billing</h2>
                ...
                <p
                    ...
                    class="mt-4 border border-snitch-ink/15 bg-snitch-spot/25 px-3 py-2 text-sm text-snitch-ink"
                >
                    Checkout complete. Stripe may take a moment to confirm your subscription.
                </p>
                <p
                    v-else-if="checkoutStatus === 'cancelled'"
                    class="mt-4 border border-snitch-ink/15 bg-snitch-ink/[0.04] px-3 py-2 text-sm text-snitch-ink/75"
                >
                    Checkout cancelled. Your plan is unchanged.
                </p>

                <div
                    class="mt-5 border border-snitch-ink/12 bg-snitch-ink/[0.03] px-4 py-3"
                >
