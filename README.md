<p align="center">
  <img src="public/images/brand/mascot-mark.png" alt="Snitch" width="88" height="88" />
</p>
...
<p align="center">
  <a href="https://www.snitchsocial.net"><img src="https://img.shields.io/badge/Website-www.snitchsocial.net-F0C400?style=for-the-badge&labelColor=1C1B1A" alt="Website" /></a>
  <a href="https://github.com/tmwclaxton/snitch"><img src="https://img.shields.io/badge/GitHub-Source-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub" /></a>
  <a href="https://www.snitchsocial.net/pricing"><img src="https://img.shields.io/badge/Pricing-£5_starter_·_£19%2Fmo-3A5F6B?style=for-the-badge&labelColor=1C1B1A" alt="Pricing" /></a>
  <a href="https://www.snitchsocial.net/how-it-works"><img src="https://img.shields.io/badge/How_it_works-Track_·_Analyze_·_Win-3A5F6B?style=for-the-badge&labelColor=1C1B1A" alt="How it works" /></a>
</p>
...
<p align="center">
  <a href="https://www.snitchsocial.net/analytics"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fwww.snitchsocial.net%2Fanalytics.json&query=%24.metrics.posts_synced.total&label=Posts%20synced&color=F0C400&labelColor=1C1B1A" alt="Posts synced" /></a>
  <a href="https://www.snitchsocial.net/analytics"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fwww.snitchsocial.net%2Fanalytics.json&query=%24.metrics.analyses_completed.total&label=Analyses%20completed&color=F0C400&labelColor=1C1B1A" alt="Analyses completed" /></a>
  <a href="https://www.snitchsocial.net/analytics"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fwww.snitchsocial.net%2Fanalytics.json&query=%24.metrics.winners_scored.total&label=Winners%20scored&color=F0C400&labelColor=1C1B1A" alt="Winners scored" /></a>
</p>
...
<p align="center">
  <img src="public/images/marketing/og.jpg" alt="Snitch - see what competitors post, remake what wins" width="720" />
</p>
...
```mermaid
flowchart LR
    A["🏷️ Brand context<br/>Website autofill"] --> B["🕵️ Track Snitches<br/>Handles + AI suggest"]
    B --> C["📡 Sync public posts<br/>Apify / TikHub"]
    C --> D["🧠 Full-video analysis<br/>NanoGPT + music"]
    D --> E["🏆 Score Winners<br/>Your rules"]
    E --> F["✂️ Remake the craft<br/>How-to-copy notes"]
    B --> G["🤝 Brand Deals<br/>Find creators"]
    F --> H["🤖 Agents MCP<br/>Cursor / Claude"]
```
...
<table>
  <tr>
    <td valign="top"><img src="public/images/platforms/tiktok.svg" width="18" height="18" alt="" /> TikTok</td>
    <td valign="top"><img src="public/images/platforms/instagram.svg" width="18" height="18" alt="" /> Instagram</td>
    <td valign="top"><img src="public/images/platforms/youtube.svg" width="18" height="18" alt="" /> YouTube</td>
    <td valign="top"><img src="public/images/platforms/facebook.svg" width="18" height="18" alt="" /> Facebook</td>
    <td valign="top"><img src="public/images/platforms/linkedin.svg" width="18" height="18" alt="" /> LinkedIn</td>
  </tr>
</table>
...
```mermaid
flowchart TB
    subgraph Web["Inertia + Vue"]
        UI["Feed · Snitches · Brand Deals · Winners · Explore · Billing · Agents"]
    end

    subgraph Laravel["Laravel 13"]
        CTRL["Controllers + Form requests"]
        MCP["MCP server<br/>Sanctum + Passport"]
        JOBS["Queue jobs<br/>sync · analyze · score · suggest · find"]
        SVC["Services<br/>Apify · TikHub · Analysis · Firecrawl · Billing"]
