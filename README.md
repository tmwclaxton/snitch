...
<p align="center">
  <a href="https://snitchsocial.net"><img src="https://img.shields.io/badge/Website-snitchsocial.net-F0C400?style=for-the-badge&labelColor=1C1B1A" alt="Website" /></a>
  ...
  <a href="https://snitchsocial.net/how-it-works"><img src="https://img.shields.io/badge/How_it_works-Track_·_Analyze_·_Win-3A5F6B?style=for-the-badge&labelColor=1C1B1A" alt="How it works" /></a>
</p>
...
<p align="center">
  <a href="https://snitchsocial.net/analytics"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fsnitchsocial.net%2Fanalytics.json&query=%24.metrics.posts_synced.total&label=Posts%20synced&color=F0C400&labelColor=1C1B1A" alt="Posts synced" /></a>
  <a href="https://snitchsocial.net/analytics"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fsnitchsocial.net%2Fanalytics.json&query=%24.metrics.analyses_completed.total&label=Analyses%20completed&color=F0C400&labelColor=1C1B1A" alt="Analyses completed" /></a>
  <a href="https://snitchsocial.net/analytics"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fsnitchsocial.net%2Fanalytics.json&query=%24.metrics.winners_scored.total&label=Winners%20scored&color=F0C400&labelColor=1C1B1A" alt="Winners scored" /></a>
</p>
...
```mermaid
flowchart LR
    A["🏷️ Brand context<br/>Website autofill"] --> B["👥 Track rivals<br/>Handles + AI suggest"]
    B --> C["📡 Sync public posts<br/>Apify · recency window"]
    C --> D["🧠 Full-video analysis<br/>NanoGPT"]
...
flowchart TB
    subgraph Web["Inertia + Vue"]
        UI["Feed · Competitors · Winners · Explore · Dashboard"]
    end

    subgraph Laravel["Laravel 13"]
        CTRL["Controllers + Form requests"]
        JOBS["Queue jobs<br/>sync · analyze · score · suggest"]
        SVC["Services<br/>Apify · Analysis · Firecrawl · Winners"]
